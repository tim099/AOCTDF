#include "class/game/ageOfCube/map/attack/missile/BombLauncher.h"
...
void BombLauncher::draw_weapon(){
	Display::DrawObject* dobj=Display::AllDrawObjects::get_cur_object()->get("attack/cube_missile_launcher");
