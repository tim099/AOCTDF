...
Pknight::Pknight() {
	draw_piece1=Display::AllDrawObjects::get_cur_object()->get("chess/pknight");
	draw_piece2=Display::AllDrawObjects::get_cur_object()->get("chess/pknight");
	weight=90;
...
void Pknight::next_step(CM::Board<short int> *chess_board,
