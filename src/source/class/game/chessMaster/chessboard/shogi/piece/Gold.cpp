...
Gold::Gold() {
	draw_piece1=Display::AllDrawObjects::get_cur_object()->get("chess/gold");
	draw_piece2=Display::AllDrawObjects::get_cur_object()->get("chess/gold");
	weight=90;
	name="Gold";
}
Gold::~Gold() {
...
void Gold::next_step(CM::Board<short int> *chess_board,
