...
Ppawn::Ppawn() {
	draw_piece1=Display::AllDrawObjects::get_cur_object()->get("chess/ppawn");
	draw_piece2=Display::AllDrawObjects::get_cur_object()->get("chess/ppawn");
	weight=90;
	name="Promoted Pawn";
}
Ppawn::~Ppawn() {
...
void Ppawn::next_step(CM::Board<short int> *chess_board,
